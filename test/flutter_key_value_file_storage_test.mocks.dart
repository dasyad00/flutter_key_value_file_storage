...
// in flutter_key_value_file_storage/test/flutter_key_value_file_storage_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockFileStorage extends _i1.Mock implements _i6.FileStorage {
  MockFileStorage() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<_i7.Uint8List?> read(String? filename) => (super.noSuchMethod(
        Invocation.method(
          #read,
          [filename],
        ),
  ...
  @override
  _i5.Future<bool> exists(String? filename) => (super.noSuchMethod(
        Invocation.method(
          #exists,
          [filename],
        ),
  ...
  @override
  _i5.Future<void> delete(String? filename) => (super.noSuchMethod(
        Invocation.method(
          #delete,
          [filename],
        ),
